...
class ResetScreen extends StatefulWidget {
  ...
  ResetScreen(this.novoEmail, this.novoNome, this.imagemPerfil);

  @override
  _ResetScreenState createState() =>
      _ResetScreenState(novoEmail, novoNome, imagemPerfil);
}
...
class _ResetScreenState extends State<ResetScreen> {
  ...
  _ResetScreenState(this.novoEmail, this.novoNome, this.imagemPerfil);
